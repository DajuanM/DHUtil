...
extension UIAlertController {
    ...
    func addImagePicker(flow: UICollectionView.ScrollDirection, paging: Bool, height: CGFloat? = nil, images: [UIImage], selection: ImagePickerViewController.SelectionType? = nil) {
...
final class ImagePickerViewController: UIViewController {
    ...
    required init(flow: UICollectionView.ScrollDirection, paging: Bool, data: [UIImage], selection: SelectionType?) {
        self.data = data
